...
killicon.AddFont("weapon_zs_gravgun", "zsdeathnotice", ",")
...
killicon.AddFont("weapon_zs_grenade", "zsdeathnoticecs", "O")
...
killicon.AddFont("weapon_zs_hermes", "zsdeathnotice", "/")
...
killicon.AddFont("weapon_zs_succubus", "zsdeathnoticecs", "d")
killicon.Add("weapon_zs_blaster", "zombiesurvival/killicons/weapon_zs_blaster")
killicon.Add("weapon_zs_airstrike", "zombiesurvival/killicons/weapon_zs_blaster")
...
killicon.AddFont("weapon_zs_duckbill", "zsdeathnoticecs", "B")
...
killicon.Add("weapon_zs_golfclub", "zombiesurvival/killicons/weapon_zs_pipe")
...
killicon.Add("weapon_zs_bandito", "tropical/killicons/weapon_zs_bandito")
killicon.Add("weapon_zs_junkpack", "tropical/killicons/weapon_zs_junkpack")
killicon.Add("weapon_zs_sigilseed", "tropical/killicons/weapon_zs_sigilseed")
killicon.Add("weapon_zs_sigilshard", "tropical/killicons/weapon_zs_sigilshard")
killicon.Add("weapon_zs_impulsegrenade", "tropical/killicons/weapon_zs_impulsegrenade")
killicon.Add("weapon_zs_impactgrenade", "tropical/killicons/weapon_zs_impactgrenade")
killicon.Add("weapon_zs_workers_gloves", "tropical/killicons/weapon_zs_workers_gloves")
...
net.Receive("zs_playerredeemed", function(length)
	...
	if pl:IsValid() then
		...
		if pl == MySelf then
			GAMEMODE:CenterNotify(COLOR_CYAN, translate.Get("you_redeemed"), " ", {killicon = "redeem"})
...
net.Receive("zs_can_redeem", function(length)
	GAMEMODE:CenterNotify(COLOR_WHITE, {killicon = "redeem"}, " ", translate.Get("can_redeem"), " ", {killicon = "redeem"})
	GAMEMODE:CenterNotify(COLOR_WHITE, translate.Get("press_f2_to_redeem"))
	surface.PlaySound("ambient/levels/citadel/zapper_warmup1.wav")
end)
