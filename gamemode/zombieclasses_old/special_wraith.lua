...
function CLASS:GetAlpha(pl)
	...
	local minvisrange = 400
	local maxvisrange = 150
	local minvis = 0 --yeah idk i dont blame you tbh
	local maxvis = 0.7

	local vis = Lerp((dist - mixvisrange)/minvisrange,max, minvis)
	*/
