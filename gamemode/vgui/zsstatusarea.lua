...
{
	Color = Color(120, 240, 0),
	Name = "RADIATION!",
	ValFunc = function(self, lp)
		return lp:GetRadiationDamage()
	end,
	Max = GM.MaxRadiationDamage or 50,
	Icon = Material("tropical/radiation.png")
},
{
...
},
{
	...
	Name = "CRIPPLED!",
	ValFunc = statusValueFunction("cripple"),
	Max = 7,
...
},
{
	...
	Name = "REGEN!",
	ValFunc = function(self, lp)
		local status = lp:GetStatus("bloodbag_heal")
		if status and status:IsValid() then
			return status:GetAmount()
		end
	end,
	Max = 200,
	Icon = Material("tropical/heal.png")
},
{
	Color = Color(255, 125, 125),
	Name = "LIFESTEAL!",
	ValFunc = function(self, lp)
		local status = lp:GetStatus("necromancer_heal")
		if status and status:IsValid() then
			return status:GetAmount()
		end
	end,
...
},
{
	Color = Color(130, 30, 140),
	Name = "HERMES!",
	ValFunc = statusValueFunction("hermes"),
	Max = 14,
	Icon = Material("zombiesurvival/speed_up.png")
},
{
	Color = Color(157, 75, 20),
	Name = "HITSTUN!",
	ValFunc = statusValueFunction("hitstun"),
	Max = 1,
	Icon = Material("zombiesurvival/knock_down.png")
},
{
