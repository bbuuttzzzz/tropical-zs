...
DT_PLAYER_PHASE_DECAY = 5
DT_PLAYER_FLOAT_PHANTOMHEALTH = 6
DT_PLAYER_INT_CLASS = 10
DT_PLAYER_INT_BOSS = 11
DT_PLAYER_INT_MINI_BOSS = 12
...
--zombie spawn menu spawn types
SPAWNTYPE_DARKNEST = 1
SPAWNTYPE_MINIBOSS = 2
SPAWNTYPE_NEST = 3
...
GM.BarricadeHealthMax = 500
GM.BarricadeHealthMassFactor = 2 * 0.6
GM.BarricadeHealthVolumeFactor = 4 * 0.6
GM.BarricadeRepairCapacity = 1000//1.25

GM.BossZombiePlayersRequired = 6
GM.PlayersPerMiniboss = 4
...
GM.AmmoNames["grenade_impulse"] = "Impulse Grenades"
GM.AmmoNames["grenade_impact"] = "Impact Grenades"
...
GM.AmmoNames["sigilseed"] = "Sigil Seeds"
...
GM.AmmoModels["grenade"] = "models/weapons/w_eq_fraggrenade.mdl" -- Grenades
GM.AmmoModels["grenade_impulse"] = "models/weapons/w_eq_flashbang.mdl" -- Grenades
GM.AmmoModels["grenade_impact"] = "models/weapons/w_grenade.mdl" -- Grenades
...
GM.AmmoModels["sigilseed"] = "models/props_phx/gibs/flakgib1.mdl"
...
GM.AmmoModels["scrap"] = "models/Items/combine_rifle_cartridge01.mdl"
