...
function ENT:StartTouch(ent)
	if self.DieTime ~= 0 and ent:IsValidLivingZombie() and ent:Health() < ent:GetMaxHealth() and not ent:GetStatus("shockdebuff") --[[and not ent:GetZombieClassTable():IsBoss()]] then
		self.DieTime = 0
