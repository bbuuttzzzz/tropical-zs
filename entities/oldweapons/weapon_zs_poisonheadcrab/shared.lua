...
--speeds for the WINDUP of your leap and spit
SWEP.LeapSpeedFrac = 0.5
SWEP.SpitSpeedFrac = 0.3
...
function SWEP:PrimaryAttack()
	...
	self.oldwalkspeed = self:GetOwner():GetWalkSpeed()
	self.oldrunspeed = self:GetOwner():GetRunSpeed()
	GAMEMODE:SetPlayerSpeed(self:GetOwner(), self.oldwalkspeed * self.LeapSpeedFrac, self.oldrunspeed * self.LeapSpeedFrac)
...
function SWEP:SecondaryAttack()
	...
	self.oldwalkspeed = self:GetOwner():GetWalkSpeed()
	self.oldrunspeed = self:GetOwner():GetRunSpeed()
	GAMEMODE:SetPlayerSpeed(self:GetOwner(), self.oldwalkspeed * self.SpitSpeedFrac, self.oldrunspeed * self.SpitSpeedFrac)
